...
def get_column_info(X, y):
    try:
        ...
        numerical_features = X.select_dtypes(include=['int64', 'float64', 'int32'])
        ...
        for column in object_features.columns:
            ...
            object_recommendations[column] = encoding_recommendation
        ...
        for col, encoding in object_recommendations.items():
